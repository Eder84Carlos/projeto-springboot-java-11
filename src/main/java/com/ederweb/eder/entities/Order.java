...
public class Order implements Serializable {
	...
	@OneToOne(mappedBy = "order", cascade = CascadeType.ALL) //mapeamento de codigo com mesmo id do pedido com o pagamento
	...
	public Double getTotal() {    //vai varrer os itens de pedidos e somar para ter o valor total do pedido
		double sum = 0.0;
